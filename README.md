...
Добавьте бота в каждую рабочую группу и вызовите там `/startmeet` от имени администратора. Бот запомнит группу и будет присылать новую ссылку с понедельника по четверг в 10:30 МСК. Для отключения используйте `/stopmeet`.
